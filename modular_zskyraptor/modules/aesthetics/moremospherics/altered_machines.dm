/obj/machinery/atmospherics/components/trinary
	icon = 'modular_zskyraptor/modules/aesthetics/moremospherics/icons/trinary_devices.dmi'
...
/obj/machinery/atmospherics/components/binary
	icon = 'modular_zskyraptor/modules/aesthetics/moremospherics/icons/binary_devices.dmi'

/obj/machinery/atmospherics/components/unary
	icon = 'modular_zskyraptor/modules/aesthetics/moremospherics/icons/unary_devices.dmi'
...
/datum/greyscale_config/meter
	icon_file = 'modular_zskyraptor/modules/aesthetics/moremospherics/icons/pipes/meter.dmi'



/obj/machinery/atmospherics/components/unary/thermomachine
	icon = 'modular_zskyraptor/modules/aesthetics/moremospherics/icons/thermomachine.dmi'
...
/datum/greyscale_config/thermomachine
	icon_file = 'modular_zskyraptor/modules/aesthetics/moremospherics/icons/thermomachine.dmi'
