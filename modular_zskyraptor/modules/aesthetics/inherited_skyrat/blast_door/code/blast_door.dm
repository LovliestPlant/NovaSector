/obj/machinery/door/poddoor
	icon = 'modular_zskyraptor/modules/aesthetics/inherited_skyrat/blast_door/icons/blast_door.dmi'
	var/door_sound = 'modular_zskyraptor/modules/aesthetics/inherited_skyrat/blast_door/sound/blast_door.ogg'
