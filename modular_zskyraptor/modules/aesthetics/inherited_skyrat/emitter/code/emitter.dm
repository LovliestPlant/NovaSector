/obj/machinery/power/emitter
	icon = 'modular_zskyraptor/modules/aesthetics/inherited_skyrat/emitter/icons/emitter.dmi'

/obj/machinery/field/containment
	icon = 'modular_zskyraptor/modules/aesthetics/inherited_skyrat/emitter/icons/emitter.dmi'

/obj/machinery/field/generator
	icon = 'modular_zskyraptor/modules/aesthetics/inherited_skyrat/emitter/icons/field_generator.dmi'
